 ...
 */
static __inline int_least32_t minmea_rescale(struct minmea_float *f, int_least32_t new_scale)
{
    if (f->scale == 0)
        return 0;
 ...
 */
static __inline float minmea_tofloat(struct minmea_float *f)
{
    if (f->scale == 0)
        return NAN;
 ...
 * Returns NaN for "unknown" values.
 */
static __inline float minmea_tocoord(struct minmea_float *f)
{
	int_least32_t degrees;
	int_least32_t minutes;
    if (f->scale == 0)
        return NAN;
